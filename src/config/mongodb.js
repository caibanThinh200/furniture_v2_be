...
var MONGO_URI = typeof (process.env.MONGO_URI) !== "string" ? JSON.stringify(process.env.MONGO_URI) : process.env.MONGO_URI;
var MongoProvider = /** @class */ (function () {
    function MongoProvider() {
        this.MongoConnection();
    }
    MongoProvider.getInstance = function () {
        if (!MongoProvider.instance) {
            MongoProvider.instance = new MongoProvider();
        }
        return MongoProvider.instance;
    };
    MongoProvider.prototype.MongoConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mongoose_1["default"].connect(MONGO_URI, function (err) {
